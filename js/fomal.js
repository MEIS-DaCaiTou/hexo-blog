...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://blog-data-6y4.pages.dev/img/imgdata_01/【哲风壁纸】原神-芙芙.png);
    --darkmode-bg:url(https://blog-data-6y4.pages.dev/img/imgdata_01/【哲风壁纸】原神-芙芙.png);
    --mobileday-bg: url(https://blog-data-6y4.pages.dev/img/imgdata_01/【哲风壁纸】原神-芙芙.png);
    --mobilenight-bg: url(https://blog-data-6y4.pages.dev/img/imgdata_01/【哲风壁纸】原神-芙芙.png);
  }`;
}
// 切换背景主函数
function changeBg(s) {
